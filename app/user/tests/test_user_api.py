...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Testing a user alreaduy existas fails"""
    ...
    def test_password_too_short(self):
        ...
        payload = { 'email': 'test@test1.com', 'password': 'pw', 'name': 'Test' }
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        payload_for_create_user = { 'email': 'test@test.com', 'password': 'testpass', 'name': 'Test' }
        create_user(**payload_for_create_user)
    ...
    def test_create_token_missing_field(self):
        ...
        res = self.client.post(TOKEN_URL, {'email': 'blah', 'password': ''})
        self.assertNotIn('token', res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)